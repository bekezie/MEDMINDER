...
const MedicineCard = (props) => {
  ...
  return (
    <div className="card mt-3 me-3 border border-dark">
      <div className="card-body">
        {!showEditForm && (
          <div>
            <h3 className="card-title">Name: {props.medicine.medicineName}</h3>
            <p className="card-text">Dosage: {props.medicine.medicineDosage}</p>
